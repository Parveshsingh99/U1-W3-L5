...
whoIsBigger(9.93992, 9.87429)
/* ESERCIZIO 3
  Crea una funzione chiamata "splitMe" che riceve una stringa come parametro e ritorna un'array contenente ogni parola della stringa.

  Es.: splitMe("I love coding") => ritorna ["I", "Love", "Coding"]
*/
const splitMe = function(ciao) {
  return ciao.trim().split(/\s+/);
}
console.log(splitMe)
...
*/
const deleteOne = function (stringa1, stringa2) {
  if (stringa2 === true) {
...
let w1 = "good morning"
let w2 = false
console.log(deleteOne(w1, w2))
/* ESERCIZIO 5
  Crea una funzione chiamata "onlyLetters" che riceve una stringa come parametro e la ritorna eliminando tutte le cifre numeriche.

  Es.: onlyLetters("I have 4 dogs") => ritorna "I have dogs"
*/
const onlyLetters = function(cane) {
  cane = "ho 4 cani"
  console.log(cane.replace(4,""))
}
onlyLetters()
/* ESERCIZIO 6
...
const day2 = today - day
const difference = Math.floor(day2 / (24 * 60 * 60 * 1000))
return difference - 1 
}
console.log(howManyDays("1999-03-31"))
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
function isTodayMyBirthday() {
  const today = new Date();
  const birthDate = new Date(today.getFullYear(), 2, 31); // September 15th
...
*/
const deleteProp = function (object, stringaa) {
  delete object[stringaa]
  return object
}
const topo = {
  name: "Gigio",
...
console.log(topo)
const newTopo = deleteProp(topo, "year")
console.log(newTopo)
/* ESERCIZIO 12
  Scrivi una funzione chiamata "newestMovie" che trova il film più recente nell'array "movies" fornito.
*/
const newestMovie = (array) => {
  let result = { Year: 2005 }
  array.forEach((movie) => {
...
*/
function addColoredBackgroundToLinks() {
...
*/
function addElementToUList() {
  const myList = document.getElementById("myList");
  const newElement = document.createElement("li");
  newElement.textContent = "CHE FATICA";
